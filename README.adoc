...
Build an exception use optional fields: `code`, `message`, `tip`, `level`, `data`.
...
see link:exception-spring-mvc/src/main/java/com/yangxiaochen/exception/spring/ExceptionHandler.java[spring mvc exception handler]
...
see link:exception-dubbo/src/main/java/com/yangxiaochen/exception/dubbo/GlobalExceptionFilter.java[dubbo filter]
